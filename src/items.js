    ...
    "daily-issue": {
      Sharing: [
        ...
        },
        {
          ...
          price: 23,
          image: "../images/pot-of-mussels-n-clams.JPG"
        },
        {
        ...
        },
        {
          ...
          price: 15,
          image: "../images/portbello-fries.JPG"
        },
        {
          name: "TRUFFLE FRIES ",
          description: "straight-cut fries, truffle oil, truffle mayonnaise",
          price: 15,
      ...
      Mains: [
        ...
        },
        {
          ...
          price: 26,
          image: "../images/portbello-cheese-burger.JPG"
        }
      ],
      Seafood: [
        ...
        { name: "RED SNAPPER", description: "", price: "12/100G" },
        {
          ...
          description:
            "Cooking Style: - hong kong style with coriander - teochew steamed with pickled vegetables, tomato, shitake mushroom, tofu & plum - sour spicy steamed with pickled vegetables, lemongrass, tomato & plum - sichuan boiled fish with bean sprouts & tofu - ikan bakar with TCS signature sambal, lemon & salad Additional bee hoon or kway teow on fish +8 ",
          price: "15/100G"
        },
        {
      ...
      "Eggs And More": [
        {
          ...
          description:
            "creamed mushroom, maple glazed bacon, tater tots, chicken cheese sausage, cherry tomatoes, whipped butter, sour dough. choice of eggs: sunny-side up | runny | scrambled | poached",
          price: 24
        },
        {
